...
Write a library once in Python. Get native, idiomatic code in every language.
...
| ---------- | ------------ | -------- | ----------- |
| C          | GCC 13       | Jul 2023 | Prototype   |
| C#         | .NET 8       | Nov 2023 | Prototype   |
| Dart       | Dart 3.2     | Nov 2023 | Prototype   |
...
| Swift      | Swift 5.9    | Sep 2023 | In Progress |
