"""E2E codegen test runner wrapper with file I/O - not in subset."""
# tongues: skip
...
def main() -> int:
    if len(sys.argv) < 2:
        print("Usage: run_codegen_testsw.py <tests_directory>", file=sys.stderr)
        return 1
    ...
    runner = os.path.join(script_dir, "run_codegen_tests.py")
